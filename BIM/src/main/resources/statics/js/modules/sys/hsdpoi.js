function  initlist () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
            ...
            { label: '所属图层', name: 'typeMenu', index: 'typeMenu', sortable:false, width: 80 },
            { label: '类型', name: 'typeName', index: 'typeName', sortable:false, width: 80 },
            //{ label: '所属图层', name: 'typeId',  width: 60, align: "center", sortable: false, editable: false, formatter: alarmFormatter },
			{ label: '名称', name: 'name', index: 'name', sortable:false, width: 80 },
			{ label: '经度', name: 'lng', index: 'lng',  sortable:false,width: 80 },
			{ label: '纬度', name: 'lat', index: 'lat', sortable:false, width: 80 },
			{ label: '电话', name: 'tel', index: 'tel', sortable:false, width: 80 },
			{ label: '地址', name: 'address', index: 'address', sortable:false, width: 80 },
			{ label: '部门', name: 'depart', index: 'depart', sortable:false, width: 80 },
			{ label: '简介', name: 'jianjie', index: 'jianjie',  sortable:false,width: 80 },
			{ label: '历史', name: 'history', index: 'history',  sortable:false,width: 80 }
